...
We use modern tooling to maintain code quality:
...
Test preview builds locally:
```bash
# Build a preview
scripts/preview.js build [branch-name]

# Manually publish a preview
...
> **Note**: For manual preview operations, you'll need Cellar credentials. See `scripts/preview.js -h` for details.
...
1. **Pull Requests** → Preview builds for testing
