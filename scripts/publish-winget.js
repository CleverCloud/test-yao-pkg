...
runCommand(async () => {
  ...
  try {
    ...
    console.log('=> Update failed, attempting to create new package...');
    try {
      ...
      console.error('Update error:', updateError instanceof Error ? updateError.message : updateError);
      console.error('Create error:', createError instanceof Error ? createError.message : createError);
      throw createError;
    }
  }
});
