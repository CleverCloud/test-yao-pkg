...
* **accesslogs:** support --app argument ([d774a74](https://github.com/CleverCloud/test-yao-pkg/commit/d774a749424dd7aaaa6be825749f4df2f3cf4857))
* **accesslogs:** use API v4 and disable add-on support for now ([619095d](https://github.com/CleverCloud/test-yao-pkg/commit/619095d99b10ce710e197fba31b72fcf14e3f71e))
* **activity:** add `--format json|json-stream|human` option ([da23737](https://github.com/CleverCloud/test-yao-pkg/commit/da23737a3ec40b1fd157f8dab6a2783ccb61383a)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **activity:** add deployment id ([094ce7c](https://github.com/CleverCloud/test-yao-pkg/commit/094ce7c93518d31884eaa0f4953c41bd8f944a8e)), closes [#430](https://github.com/CleverCloud/test-yao-pkg/issues/430) [#193](https://github.com/CleverCloud/test-yao-pkg/issues/193)
* **activity:** shorten commit id ([a977360](https://github.com/CleverCloud/test-yao-pkg/commit/a977360d34850d2a1280b5bab84f9c032455d03b))
* **activity:** support --app argument ([9431f31](https://github.com/CleverCloud/test-yao-pkg/commit/9431f31bb8fea2c4d1ad2542051d357fcf170ea3))
* add 'clever-tools' as binary ([e9dd580](https://github.com/CleverCloud/test-yao-pkg/commit/e9dd580978b752d109477429aa110040dc0bf30d))
* add a --no-color global option ([90a4e10](https://github.com/CleverCloud/test-yao-pkg/commit/90a4e107185b23e6761e8e64b902cb79c5c445c0)), closes [#631](https://github.com/CleverCloud/test-yao-pkg/issues/631)
* add new Gravelines HDS region to autocomplete ([fbebd40](https://github.com/CleverCloud/test-yao-pkg/commit/fbebd406f674bbebc1e9e88a84f2e8270e6b0f7a))
* add PR preview build system ([fc9edc3](https://github.com/CleverCloud/test-yao-pkg/commit/fc9edc31944cd5610070bbe5a565bdaa66a7dec4))
* **addon create:** choose the cheapest plan by default ([87376f8](https://github.com/CleverCloud/test-yao-pkg/commit/87376f8ac3c03cdf01082e13bfbe8c637d951d2d)), closes [#653](https://github.com/CleverCloud/test-yao-pkg/issues/653)
* **addon providers show:** add `--format json|human` option ([23bfac6](https://github.com/CleverCloud/test-yao-pkg/commit/23bfac60400f05b277fd2392e50c39bd439580e8)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **addon providers:** add `--format json|human` option ([9b806a1](https://github.com/CleverCloud/test-yao-pkg/commit/9b806a142f7f0e7b304daee7f56b2c736f8556a5)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **addon-create:** add support for JSON format (-F json) ([334cec5](https://github.com/CleverCloud/test-yao-pkg/commit/334cec56a43e0e511a4eaae17350a6caea912576))
* **addon:** add a parser to check options format ([081c23c](https://github.com/CleverCloud/test-yao-pkg/commit/081c23ca9d3e7b897c62be0528124f86e697bbbf))
* **addon:** add Keycloak temporary password instructions ([cc66497](https://github.com/CleverCloud/test-yao-pkg/commit/cc664977ba565c267bf0c37bc761a12b654784cb))
* **addon:** add URL to use/manage add-on at creation ([36226c5](https://github.com/CleverCloud/test-yao-pkg/commit/36226c566e2b7468f38297f57a80c198e90c1f9c))
* **addon:** elastic plugins option support ([2ec8651](https://github.com/CleverCloud/test-yao-pkg/commit/2ec865153b602b8fdcbb1304d4ca171e5acd2341))
* **addon:** enable materia kv ([341a3fa](https://github.com/CleverCloud/test-yao-pkg/commit/341a3fa9b4d74d422750b6755c59dadeb5a584b1))
* **addon:** enable string value for option keys ([9f36289](https://github.com/CleverCloud/test-yao-pkg/commit/9f36289f49389aafb7fe4d01920bcef7c81a0519))
* **addon:** list available addon providers when invalid provider is specified ([e7684fe](https://github.com/CleverCloud/test-yao-pkg/commit/e7684fe6817780f726318d1d0fdbedec01c448c5))
* **addon:** remove beta status from Keycloak, Matomo, Metabase and Otoroshi ([adc6b5c](https://github.com/CleverCloud/test-yao-pkg/commit/adc6b5c58514b4d5067744d374650f5bdfa8d808))
* **addon:** support JSON format when plotting an add-on list ([d01b3e0](https://github.com/CleverCloud/test-yao-pkg/commit/d01b3e01db9097dad2e77347525a273732c7ffe9))
* **applications:** add list subcommand to list all applications ([f654588](https://github.com/CleverCloud/test-yao-pkg/commit/f6545889d98a585510516a7ee56b7c41dad6466d))
* **backups:** support JSON format when plotting a backup list ([c51c028](https://github.com/CleverCloud/test-yao-pkg/commit/c51c028b8d25fd25d2bac91e408c63ae3acdfea9))
* **cancel-deploy:** improve display (texts and colors) ([c8614e9](https://github.com/CleverCloud/test-yao-pkg/commit/c8614e9c11eefb41b55635084112cb70d6bbf5e2))
* **cancel-deploy:** support --app argument ([4e9d859](https://github.com/CleverCloud/test-yao-pkg/commit/4e9d859f61395ca74a1aaf53773af3c59515dbac))
* **config:** add support for "task" config ([deb3e26](https://github.com/CleverCloud/test-yao-pkg/commit/deb3e261c30a5cda0fb9d1ffb88aaca284364aa0))
* **config:** improve display for `list`, `get`, `set` and `update` commands ([e277eb1](https://github.com/CleverCloud/test-yao-pkg/commit/e277eb1916e4d49f6b75ec42e58635aad9e89172))
* **config:** support --app argument ([2614111](https://github.com/CleverCloud/test-yao-pkg/commit/2614111316480ba62fe4c1f3b55d181f1e0b91e8))
* **console:** open the Console even if no app is linked ([111fc51](https://github.com/CleverCloud/test-yao-pkg/commit/111fc519a76f4bf3e69455c2a4cd196818905c50))
* **console:** support --app argument ([7253799](https://github.com/CleverCloud/test-yao-pkg/commit/725379950492c1b3610aee47c340125dcc7a9ae5))
* **create:** add support for JSON format (-F json) ([1f7842a](https://github.com/CleverCloud/test-yao-pkg/commit/1f7842a3a9d0e4f8b1d235f13fd6c5dc06dc0fc0))
* **create:** add the ability to create an app as a task ([c217772](https://github.com/CleverCloud/test-yao-pkg/commit/c217772638035cab0c6f26a75c250759ab5d0cdc))
* **create:** display name once app (or add-on) is created ([1a3eb9e](https://github.com/CleverCloud/test-yao-pkg/commit/1a3eb9ea9acf44aebc431b617cbf7d522b27d880))
* **create:** improve display (texts and colors) ([c36ebc9](https://github.com/CleverCloud/test-yao-pkg/commit/c36ebc905e5fde258ab9c7a884e000a23280ad2f))
* **create:** make app name optional (use current directory name if not specified) ([0a20393](https://github.com/CleverCloud/test-yao-pkg/commit/0a2039302f8c237616e0ba48de97a2b1de89ec88))
* **curl:** add a clever curl help message ([520d04b](https://github.com/CleverCloud/test-yao-pkg/commit/520d04b08d34acfcb924c81a12fc79b8192b87d0))
* **curl:** list the command in clever help ([b6e18d2](https://github.com/CleverCloud/test-yao-pkg/commit/b6e18d2ec27c372cd34cffd850a29618085c1cf6))
* **database-backups:** rework json backup list ([5cbb381](https://github.com/CleverCloud/test-yao-pkg/commit/5cbb381f11f52ad9f14aa6dca243cb30431f63fb))
* **database:** stream backup download ([80940a3](https://github.com/CleverCloud/test-yao-pkg/commit/80940a37d193a2922cd72383f6d7432b057b00d1))
* date ([1b6a5fc](https://github.com/CleverCloud/test-yao-pkg/commit/1b6a5fce4f59692f79046712b837637aa4eda0cd))
* **delete:** improve display (texts and colors) ([c8e5c93](https://github.com/CleverCloud/test-yao-pkg/commit/c8e5c93ba92b6d1b0bd6783fae591f04bc48302f))
* **delete:** support --app argument ([7b4d6da](https://github.com/CleverCloud/test-yao-pkg/commit/7b4d6da73d83d5e1fadc39e9f48de9a69703f2e0))
* **deploy,restart:** handle exit-on option to end deployment logs ([f2e1981](https://github.com/CleverCloud/test-yao-pkg/commit/f2e1981fe09f09de9ee68e41ec02199e6823e76d))
* **deploy:** improve display (texts and colors) ([1e055f3](https://github.com/CleverCloud/test-yao-pkg/commit/1e055f3ee6ca4b27d53d6864e7071422be43a7ae))
* **deploy:** support tag option ([52ea270](https://github.com/CleverCloud/test-yao-pkg/commit/52ea270b5148d29b5c52d01321541b2227437f0a))
* **diag:** add `--format json|human` option ([922515e](https://github.com/CleverCloud/test-yao-pkg/commit/922515e472aa85d1f1e27126c8c25282a406fa55)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* display a proper message for any 401 from the API ([379c866](https://github.com/CleverCloud/test-yao-pkg/commit/379c8667c2c4b74e2e0edbec547f2ff0b3657e97))
* **docker:** add curl and jq binaries ([3b71f0e](https://github.com/CleverCloud/test-yao-pkg/commit/3b71f0e83dde74621463494a1eaade29fc7e35a5))
* **domain:** init `diag` command ([d0ce64c](https://github.com/CleverCloud/test-yao-pkg/commit/d0ce64cbbd8ebfefff9560712e2fd4366978c31b))
* **domain:** introduce domain overview command ([32e4294](https://github.com/CleverCloud/test-yao-pkg/commit/32e4294855e306fe3e139b4590ad366d3807801a))
* **domain:** support --app argument ([19d3f8e](https://github.com/CleverCloud/test-yao-pkg/commit/19d3f8e8362effb7547943d4792bc817b5502f77))
* **drain:** add `--format json|human` option ([e0f70c2](https://github.com/CleverCloud/test-yao-pkg/commit/e0f70c2559d5f54599ff5ad2fb8fd0ece6e7d9fa)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **drain:** support --app argument ([a45f0bd](https://github.com/CleverCloud/test-yao-pkg/commit/a45f0bdbd975069fad5326926aff51cf29dd848b))
* **emails:** add emails command ([0a5210f](https://github.com/CleverCloud/test-yao-pkg/commit/0a5210fbc88886d0a67c892c872d5c42fdd4e7c7))
* **env:** add `--format json|shell|human` option ([fcb25ff](https://github.com/CleverCloud/test-yao-pkg/commit/fcb25ff0afd0eb32316561457f5b48d3aa09b2df)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **env:** support --app argument ([8b02f0b](https://github.com/CleverCloud/test-yao-pkg/commit/8b02f0b9f4206e1a823a148fdcb327842dbd52b7))
* **features:** add `operator` feature for `keycloak`, `matomo`, `metabase` and `otoroshi` ([f782359](https://github.com/CleverCloud/test-yao-pkg/commit/f782359a06abcb03363b2ef02580a724341aa495))
* **features:** introduce `features` command ([5c370b3](https://github.com/CleverCloud/test-yao-pkg/commit/5c370b3bdb0ad99509004491f9360f20c0a36632))
* **help:** adjust description for help command ([85b3dec](https://github.com/CleverCloud/test-yao-pkg/commit/85b3decce9ea55cf6b5a21d2eb8a9a8be09da84d))
* **keycloak:** add keycloak command ([6dc2c59](https://github.com/CleverCloud/test-yao-pkg/commit/6dc2c594cfaaf41c0982cdb75422ba606aaf4356))
* **kv:** introduce kv command ([70f8aba](https://github.com/CleverCloud/test-yao-pkg/commit/70f8abafb4539c9587335ced87d5c414a012159e))
* **link:** improve display (texts and colors) ([5896bbd](https://github.com/CleverCloud/test-yao-pkg/commit/5896bbd195c6f9d9c0abbeb3e4f27a5236465c96))
* **logs:** support --app argument ([4cb62bf](https://github.com/CleverCloud/test-yao-pkg/commit/4cb62bf42b19a8eab0aceba1b0bb4d4364d6be38))
* **logs:** support "json" and "json-stream" formats (for apps only) ([a909959](https://github.com/CleverCloud/test-yao-pkg/commit/a909959314a3d5465d040304b2ee0036b35cde28))
* **logs:** support duration in since parameters ([a223f3a](https://github.com/CleverCloud/test-yao-pkg/commit/a223f3a77a20c6f062e8003a9548072aff0c657f))
* **logs:** support indexPrefix customization for ElasticSearch log drain ([2dc0bd6](https://github.com/CleverCloud/test-yao-pkg/commit/2dc0bd655b2b49b32bd749d5bf20b22841448446))
* **logs:** support SD-PARAM RFC5424 for UDP and TCP drains ([38407ad](https://github.com/CleverCloud/test-yao-pkg/commit/38407adff14c5d49581181b37afadb9b8e41ea24))
* **make-default:** improve display (texts and colors) ([addcac6](https://github.com/CleverCloud/test-yao-pkg/commit/addcac64b259a92dc2e7b5b68d4b1166e0f4d488))
* **matomo:** add matomo command ([8f3dafd](https://github.com/CleverCloud/test-yao-pkg/commit/8f3dafd992ef79a6956b422f79316b3f5ef66cf8))
* **metabase:** add metabase command ([8e29490](https://github.com/CleverCloud/test-yao-pkg/commit/8e29490682637ba8af56e681396de808a888bad5))
* **ng:** introduce ng command ([687042b](https://github.com/CleverCloud/test-yao-pkg/commit/687042bef5a27d50fcd9060cf1a68b9c61dee05b))
* **notify-email:** add `--format json|human` option ([6cc4e16](https://github.com/CleverCloud/test-yao-pkg/commit/6cc4e165413afdb0f8f8810f6057748866d8fade)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **open:** support --app argument ([3121d0d](https://github.com/CleverCloud/test-yao-pkg/commit/3121d0da5696d3d886608f4eae370af806fe74a3))
* **otoroshi:** add otoroshi command ([439ae13](https://github.com/CleverCloud/test-yao-pkg/commit/439ae135cbb3ca7bde5feadbeffca8b27ba4db6c))
* **parsers:** add duration parser ([62d6089](https://github.com/CleverCloud/test-yao-pkg/commit/62d60893dc6214567869b31a54e208656661b634))
* **profile:** add `--format json|human` option ([2ce27f2](https://github.com/CleverCloud/test-yao-pkg/commit/2ce27f2e988de3ca99b630af4ae265e727f3b2b0)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **profile:** open in the Console ([4ee9730](https://github.com/CleverCloud/test-yao-pkg/commit/4ee97300db24de8d4c93acb79f2f92ef9066f5e2))
* **published-config:** add `--format json|shell|human` option ([8dd42c9](https://github.com/CleverCloud/test-yao-pkg/commit/8dd42c98a15d3f7accfd194ee659badab8258325)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **published-config:** support --app argument ([7f68430](https://github.com/CleverCloud/test-yao-pkg/commit/7f684305449655ade6563eadbb199dc524d797d9))
* **restart:** improve display (texts and colors) ([248c47a](https://github.com/CleverCloud/test-yao-pkg/commit/248c47ad45c92e39fe668f33b9af6600593ff3aa))
* **restart:** support --app argument ([1ac6074](https://github.com/CleverCloud/test-yao-pkg/commit/1ac6074b305a9ecb1a10945fe3fdcc615f209ceb))
* **scale:** support --app argument ([5e89327](https://github.com/CleverCloud/test-yao-pkg/commit/5e893272b0fc3d3a6211ab8c287cff14f51127dd))
* **service:** add `--format json|human` option ([0f23885](https://github.com/CleverCloud/test-yao-pkg/commit/0f238856d72a9355a329d742f310acf9707c8166)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **service:** print a message if there is no linked service ([3d4c2bc](https://github.com/CleverCloud/test-yao-pkg/commit/3d4c2bcc4290516b53922635bc440f0af7476bbd))
* **service:** support --app argument ([0f02f78](https://github.com/CleverCloud/test-yao-pkg/commit/0f02f78c3aaa964decf5cd865ef1a90f4761363e))
* **ssh-keys:** add ssh-keys command ([2900328](https://github.com/CleverCloud/test-yao-pkg/commit/29003284fcfe34dc27de02335e642e3104bc5f78))
* **ssh:** support --app argument ([c1ef739](https://github.com/CleverCloud/test-yao-pkg/commit/c1ef739d5dd9fa4717b0ac1b782f668c3d72a81f))
* **status:** add `--format json|human` option ([d929587](https://github.com/CleverCloud/test-yao-pkg/commit/d9295871c970c0a6ded1b5c54627882ea7df6aac)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **status:** show instance lifetime (TASK/REGULAR) in status ([5c67aa7](https://github.com/CleverCloud/test-yao-pkg/commit/5c67aa76fe59ac4c242918a83d647eb038ce2fc3))
* **status:** support --app argument ([62428c9](https://github.com/CleverCloud/test-yao-pkg/commit/62428c92e176fa282c608274a0ab6e54d0a5c59e))
* **stop:** improve display (texts and colors) ([48fa89f](https://github.com/CleverCloud/test-yao-pkg/commit/48fa89f92ed181424146a19f35846907af0f927a))
* **stop:** support --app argument ([7d27b0b](https://github.com/CleverCloud/test-yao-pkg/commit/7d27b0b8debaace136d7bf7679de5861e65683cc))
* **tcp-redirs list-namespaces:** add `--format json|human` option ([02e9a9d](https://github.com/CleverCloud/test-yao-pkg/commit/02e9a9d09c99fad1bc5c63e9f02f9d38f70f61f6)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **tcp-redirs:** add `--format json|human` option ([8d14c6e](https://github.com/CleverCloud/test-yao-pkg/commit/8d14c6e5ebb38719ceec55d45e14c1ef01d08d7b)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)
* **tcp-redirs:** support --app argument ([dd0219c](https://github.com/CleverCloud/test-yao-pkg/commit/dd0219c4debac88fa12330bf1f79976010d0d0ac))
* **tokens:** add "state" in tokens list ([0ec7cc0](https://github.com/CleverCloud/test-yao-pkg/commit/0ec7cc087ec99852c4bfda6f0557b227ee8e811d))
* **tokens:** add `clever tokens` command to manage API tokens ([7044860](https://github.com/CleverCloud/test-yao-pkg/commit/7044860ee24946d044d0fbc188ee407577c3fda4))
* **tokens:** handle users with no password set ([2e6576d](https://github.com/CleverCloud/test-yao-pkg/commit/2e6576de313c90e96e79009e1ee8bc0436258da1))
* **tokens:** make `clever tokens` available without the feature flag ([9722d5b](https://github.com/CleverCloud/test-yao-pkg/commit/9722d5bff6bd36103535eaef0124d2fcdb979e1f))
* **unlink:** improve display (texts and colors) ([3b27d74](https://github.com/CleverCloud/test-yao-pkg/commit/3b27d74128545df3abefb4b7cd115ad0c7a47675))
* update to Node.js 22 ([c97e40f](https://github.com/CleverCloud/test-yao-pkg/commit/c97e40fe9eb47214a6eaf9f3b3274bd78eea2c32))
* **webhooks:** add `--format json|human` option ([4f0f9ae](https://github.com/CleverCloud/test-yao-pkg/commit/4f0f9aee164feaea9504afff3719aefb8e32ea7f)), closes [#589](https://github.com/CleverCloud/test-yao-pkg/issues/589)


### 🐛 Bug Fixes

* **activity:** fix activity list refresh when `--follow` options is enabled ([04e0133](https://github.com/CleverCloud/test-yao-pkg/commit/04e0133cdabadeed70e4494d73fcbc52fee7aea8))
* addon delete without org parameter ([24cfd5a](https://github.com/CleverCloud/test-yao-pkg/commit/24cfd5ae8826c71107d7b381d40a77d3511c8c85)), closes [#811](https://github.com/CleverCloud/test-yao-pkg/issues/811)
* **addon:** add missing `--format FORMAT` option ([cbe6fef](https://github.com/CleverCloud/test-yao-pkg/commit/cbe6fef57a4458af404bbac76d39185433f37a3f))
* **addon:** add TLS param to MateriaDB KV connect info ([dcd01c1](https://github.com/CleverCloud/test-yao-pkg/commit/dcd01c1ab2b0eb93a9ec9063d21f393216d95b4c))
* **addon:** allow json format in new list subcommand ([cec0e85](https://github.com/CleverCloud/test-yao-pkg/commit/cec0e8567286e1b56459fbc5e53da91b8ad7765b))
* **addon:** better handle options parsing ([7005bbf](https://github.com/CleverCloud/test-yao-pkg/commit/7005bbf4a12bd31c0b1949418f35f2476d032240)), closes [#856](https://github.com/CleverCloud/test-yao-pkg/issues/856)
* **addon:** status of Keycloak ([fe64a91](https://github.com/CleverCloud/test-yao-pkg/commit/fe64a911e8055a2e544de2fd313592026330c1c8))
* **addon:** update Beta providers list ([83fd0b9](https://github.com/CleverCloud/test-yao-pkg/commit/83fd0b91456d7da42147578808704854ecf91762))
* **addon:** use new goto URL for add-on ([086417f](https://github.com/CleverCloud/test-yao-pkg/commit/086417f6d2d2b5ddfb1617a79f7731e5be7beebb))
* apply strict text transformation on apps names for aliases and git remotes ([9b936c9](https://github.com/CleverCloud/test-yao-pkg/commit/9b936c9032e08aa426dc360f89e306030c3ec583))
* **build:** fix npm package ([df30809](https://github.com/CleverCloud/test-yao-pkg/commit/df308095e9e3af7dc78ecb1f4a2bffbeffbe9a38)), closes [#729](https://github.com/CleverCloud/test-yao-pkg/issues/729)
* **build:** fix PKGBUILD template for arch/AUR build ([71d37f0](https://github.com/CleverCloud/test-yao-pkg/commit/71d37f04c50fe592dc8a8ed9e74d8553404faa67)), closes [#708](https://github.com/CleverCloud/test-yao-pkg/issues/708)
* **config:** directory creation on write ([05b97d6](https://github.com/CleverCloud/test-yao-pkg/commit/05b97d6f9198c74e3c21ea9a632d52ff884e9799))
* **config:** exit with error if --enable-* and --disable-* are used at the same time ([f137732](https://github.com/CleverCloud/test-yao-pkg/commit/f1377328c1fe0e7aea401cdf7d2736c1504e8bb5))
* **config:** exit with error if config name is unknown ([788ac36](https://github.com/CleverCloud/test-yao-pkg/commit/788ac36d3a4505b36739f07a4287b8b4ee298eae))
* **config:** reject non boolean values for some config ([7080825](https://github.com/CleverCloud/test-yao-pkg/commit/708082589510bf27ec2c49e415cf34784b4502a8))
* **config:** remove undocumented behavior for `clever config CONFIG_NAME` ([3c1a19e](https://github.com/CleverCloud/test-yao-pkg/commit/3c1a19ee478131abfd177733bcab128ac4633ec9))
* **curl:** fix clever curl command when used with the auto packaged binary version ([7197f29](https://github.com/CleverCloud/test-yao-pkg/commit/7197f2967ea298672600ed6080f43b6d5e04adf7)), closes [#713](https://github.com/CleverCloud/test-yao-pkg/issues/713)
* **delete:** exit with error if app doesn't exist ([7ac000c](https://github.com/CleverCloud/test-yao-pkg/commit/7ac000ca1cdbc4d1dfed094958eea9feb8e5b286))
* **delete:** remove default app from `.clever.json` ([97233db](https://github.com/CleverCloud/test-yao-pkg/commit/97233db1c909c322a5d5636e6548890c7bc94676))
* **dependencies:** remove `text-table` from `devDependencies` ([bf020bf](https://github.com/CleverCloud/test-yao-pkg/commit/bf020bf3b7666376d37973bd32999231e4d094df)), closes [#819](https://github.com/CleverCloud/test-yao-pkg/issues/819)
* display stacktraces in verbose mode (again) ([a5f46d6](https://github.com/CleverCloud/test-yao-pkg/commit/a5f46d6b519147e34dd0d78db42b2c804ac6d4a1))
* **docker:** inject Docker hub credentials to actions ([e5e546e](https://github.com/CleverCloud/test-yao-pkg/commit/e5e546e88d5ff5f93de1384615619b883ea278bc))
* **domain:** add missing spacing within diag report ([7b0c739](https://github.com/CleverCloud/test-yao-pkg/commit/7b0c739617ca13f62fcca2ca4c71d9beb48433b3))
* **domain:** remove broken `-f` alias for filter ([1928ffb](https://github.com/CleverCloud/test-yao-pkg/commit/1928ffb25c480918a656176b611e02f0d0152b06))
* **domains/overview:** handle 403 errors ([cdd6bac](https://github.com/CleverCloud/test-yao-pkg/commit/cdd6bacc26293c4b023ac5f476b0b2b3fcf3f005)), closes [#881](https://github.com/CleverCloud/test-yao-pkg/issues/881)
* **domains/overview:** handle wildcard domains properly ([5d503fe](https://github.com/CleverCloud/test-yao-pkg/commit/5d503feccd7f251b7940473809afc8b779e06ace)), closes [#847](https://github.com/CleverCloud/test-yao-pkg/issues/847)
* **drain:** default index-prefix for elasticsearch drain should be null ([d38d0ae](https://github.com/CleverCloud/test-yao-pkg/commit/d38d0aeadfe67d3548550eba14d4debc3029e73d))
* **drain:** remove double --addon option ([b978024](https://github.com/CleverCloud/test-yao-pkg/commit/b97802450d6ea8f8934346463c7a19bb9048c407)), closes [#786](https://github.com/CleverCloud/test-yao-pkg/issues/786)
* **drain:** wrong link between command option and its processing ([fb2bae0](https://github.com/CleverCloud/test-yao-pkg/commit/fb2bae07fb861270fdb99b75b0e2b763d2324176))
* fix clever curl in packaged and node version ([0ef585f](https://github.com/CleverCloud/test-yao-pkg/commit/0ef585f949553f4d884362a48b7691b1289887a1))
* fix Node 19+ problem when overriding globalThis.crypto ([33b9092](https://github.com/CleverCloud/test-yao-pkg/commit/33b90922139871258095212b22bac898b512c564))
* **link:** ignore org ID when using an app ID ([d2301ff](https://github.com/CleverCloud/test-yao-pkg/commit/d2301ff74402491a30b901da8418aaac03f2947e))
* logs with color ([db3221b](https://github.com/CleverCloud/test-yao-pkg/commit/db3221be205181b591c539db5775ee92d5dd4393))
* **logs:** add details about configuration for specific drains ([55054d4](https://github.com/CleverCloud/test-yao-pkg/commit/55054d430c4b2bcec73cbfbd20fe9e63706c82fe))
* **logs:** allow real ID for addons with `clever logs` ([b50ae3e](https://github.com/CleverCloud/test-yao-pkg/commit/b50ae3ed8344b99d8f4837700ab6dc440179446f)), closes [#710](https://github.com/CleverCloud/test-yao-pkg/issues/710)
* **logs:** fix logs for addon (when no linked apps) ([8c6d6f1](https://github.com/CleverCloud/test-yao-pkg/commit/8c6d6f1ddc3d9f2c0d8f0bdab2bde9310f3f5f04)), closes [#644](https://github.com/CleverCloud/test-yao-pkg/issues/644)
* **logs:** increase connection timeout ([a4ec4b9](https://github.com/CleverCloud/test-yao-pkg/commit/a4ec4b90b5d3938e27679edeb7d375281def3776))
* **logs:** show addon logs when addonId is provided ([6fb99d5](https://github.com/CleverCloud/test-yao-pkg/commit/6fb99d591c0832e0cfb556f208ae479932b8d5af))
* remove automatic colors when console.error and console.warn are used ([f630c19](https://github.com/CleverCloud/test-yao-pkg/commit/f630c196b259104727cc9024c43f3dee492c6d74)), closes [#768](https://github.com/CleverCloud/test-yao-pkg/issues/768)
* remove duplicate --format option for operators version check ([9b92ff1](https://github.com/CleverCloud/test-yao-pkg/commit/9b92ff1e08d1fd0f7d047684206df6ac5b26fe4c))
* resolve ESLint errors throughout codebase ([a4ba231](https://github.com/CleverCloud/test-yao-pkg/commit/a4ba231207b3d31d5086f63ea6192e0aa4cffb8f))
* **restart:** quieter mode ([e507113](https://github.com/CleverCloud/test-yao-pkg/commit/e507113675de50c4a7e751add270deac8c260f6e))
* rework --no-update-notifier global option behavior ([0acab8b](https://github.com/CleverCloud/test-yao-pkg/commit/0acab8bebcffb18aa14832c858a6f8abf2fe598e)), closes [#649](https://github.com/CleverCloud/test-yao-pkg/issues/649)
* **rollup:** prevent build failure on MacOS ([8a6871f](https://github.com/CleverCloud/test-yao-pkg/commit/8a6871ff4738f2442aa9f4c880a9a61abc7e78c9)), closes [#864](https://github.com/CleverCloud/test-yao-pkg/issues/864)
* **service:** only print linked add-ons if --show-all is not true ([5668c08](https://github.com/CleverCloud/test-yao-pkg/commit/5668c08daef3ed304f470923e6f36a9eaa369644))
* **unlink:** remove default app from `.clever.json` ([97233db](https://github.com/CleverCloud/test-yao-pkg/commit/97233db1c909c322a5d5636e6548890c7bc94676))
* **update-notifier:** change the docs URL within the update message ([1803dce](https://github.com/CleverCloud/test-yao-pkg/commit/1803dce27d756833d30ce01674eccf73457b9570))
* **update-notifier:** set `isGlobal` to `true` ([1987408](https://github.com/CleverCloud/test-yao-pkg/commit/198740805450c3e5399db88be5c545e6136c1afd)), closes [#812](https://github.com/CleverCloud/test-yao-pkg/issues/812)
